...
import com.justdwiwt.jsonstyle.JsonArray;
import com.justdwiwt.jsonstyle.JsonObject;
import com.justdwiwt.util.HttpUtil;
...
public class JSONParserTest {
    ...
    public void fromJSON1() throws Exception {
        String json = "{\"a\": 1, \"b\": \"b\", \"c\": {\"a\": 1, \"b\": null, \"d\": " +
                "[0.1, \"a\", 1,2, 123, 1.23e+10, true, false, null]}}";
    ...
    public void fromJSON4() throws Exception {
        ...
        String json = new String(Objects.requireNonNull(HttpUtil.get(url)));
    ...
    private String getJSON() throws IOException {
        ...
        params.add(new BasicNameValuePair("params",
                "kJMudgZJvK8p8STuuxRpkUvO71Enw4C9y91PBkVTv2SMVnWG30eDKK1iAPcXnEah"));
        params.add(new BasicNameValuePair("encSecKey",
                "d09b0b95b7d5b4e68aa7a16d6177d3f00a78bfa013ba59f309d41f18a2b4ea066cdea" +
                        "7863866b6283f403ddcd3bfb51f73f8ad3c6818269ceabff934a645196faf7a9aae0" +
                        "edde6e232b279fd495140e6252503291cf819eabbd9f3373648775201a70f179b798" +
                        "1d627257d3bba5a5e1b99d0732ce3e898db3614d82bcbe1a6a8"));
